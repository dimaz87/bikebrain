set wildignore=*.o,*.html,*.md5,*.exe,*.dll,*.bak,*.png,*.jpg,*.orig,*.swp,*.swo,*.pyc,*/.git/*,*/.hg/*,*/.bzr/*,*/doxygen/*,*/CMakeFiles/*,ui/*,etc/*,*/cxxtest/*,*/v8/*,*/toolchains/*,*/thirdparty/*
